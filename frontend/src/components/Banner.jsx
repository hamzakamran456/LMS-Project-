        ...
        <div className={bannerStyles.grid}>
          <div className={bannerStyles.leftContent}>
            ...
            <p className={bannerStyles.description}>
              Create beuatiful, responsie web applications with our powerful
              tools and components. Start build your next project today.
            </p>
            ...
            <div className={bannerStyles.buttonsContainer}>
              ...
              <button
                className={bannerStyles.buttonViewDemos}
