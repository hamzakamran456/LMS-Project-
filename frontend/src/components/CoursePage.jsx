...
const SearchIcon = () => <Search className={coursePageStyles.teacherIcon} />;
...
const CoursePage = () => {
  ...
  // naviagte to course details if logged in else
  ...
  return (
    <div className={coursePageStyles.pageContainer}>
      ...
      <ToastContainer
        ...
        theme="dark"
      />
      <style jsx>{coursePageCustomStyles}</style>
    </div>
  );
};
